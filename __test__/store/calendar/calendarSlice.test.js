import { calendarSlice, clearMessage, onAddNewEvent, onClearActiveEvent, onDeleteEvent, onLoadEvents, onLogoutCalendar, onMessage, onSetActiveEvent, onUpdateEvent } from "../../../src/store/calendar/calendarSlice";
import { calendarWithActiveEventState, calendarWithEventsState, calendarWithMessageState, events, initialState } from "../../fixtures/calendarStates";
...
describe('Pruebas en calendarSlice', () => {
  ...
  test('onClearActiveEvent debería limpiar el evento activo', () => {
    ...
    const state = calendarSlice.reducer( calendarWithActiveEventState, onClearActiveEvent() );
  ...
  test('onMessage debería establecer el mensaje', () => {
    ...
    const state = calendarSlice.reducer( calendarWithActiveEventState, onMessage( message ) );
  ...
  test('clearMessage debería limpiar el mensaje', () => {
    ...
    const state = calendarSlice.reducer( calendarWithMessageState, clearMessage() );
